    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="space-y-4">
          ...
          >
            <div>
              ...
              <p class="text-xs text-gray-500 mt-1">
                已解锁 {{ store.achievements.length }} 个成就
              </p>
            </div>
            <span
      ...
      <div class="bg-white shadow rounded-lg p-6">
        ...
        <div class="space-y-4">
          <button
            @click="handleExport"
            class="w-full inline-flex items-center justify-center px-4 py-3 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 transition-colors duration-150"
          >
            <i class="pi pi-download mr-2"></i>
            导出睡眠数据 (JSON)
          </button>
          ...
          <button
            @click="triggerImport"
            class="w-full inline-flex items-center justify-center px-4 py-3 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 active:bg-gray-100 transition-colors duration-150"
          >
      ...
      <div class="bg-white shadow rounded-lg p-6">
        ...
        <div class="space-y-4">
          <button
            ...
            class="w-full inline-flex items-center justify-center px-4 py-3 border border-green-300 shadow-sm text-sm font-medium rounded-md text-green-700 bg-green-50 hover:bg-green-100 active:bg-green-200 transition-colors duration-150"
          >
      ...
      <div class="bg-white shadow rounded-lg p-6">
        ...
        <div class="space-y-4">
          <button
            ...
            class="w-full inline-flex items-center justify-center px-4 py-3 border border-red-300 shadow-sm text-sm font-medium rounded-md text-red-700 bg-red-50 hover:bg-red-100 active:bg-red-200 transition-colors duration-150"
          >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <ul class="text-sm text-gray-600 space-y-1">
            <li>
              <i class="pi pi-check text-green-500 mr-2"></i>拖拽调整睡眠时间段
            </li>
            <li>
              <i class="pi pi-check text-green-500 mr-2"></i>睡眠阶段图表分析
            </li>
            <li><i class="pi pi-check text-green-500 mr-2"></i>环境因素记录</li>
            <li>
              <i class="pi pi-check text-green-500 mr-2"></i>个性化睡眠建议
            </li>
            <li>
              <i class="pi pi-check text-green-500 mr-2"></i>目标设置与成就系统
            </li>
            <li>
              <i class="pi pi-check text-green-500 mr-2"></i>数据导入/导出
            </li>
          </ul>
        </div>
      </div>
