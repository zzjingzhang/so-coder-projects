      ...
      <div class="bg-white shadow rounded-lg p-6">
        ...
        <div class="space-y-5">
          ...
          <div class="pt-4 border-t">
            <button 
              @click="saveGoals"
              class="w-full inline-flex items-center justify-center px-6 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
