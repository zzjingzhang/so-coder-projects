...
const App = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
                ...
                <List disablePadding>
                  {selectedFiles.map((file, index) => (
                    <React.Fragment key={index}>
                      ...
                      {index < selectedFiles.length - 1 && <Divider component="li" />}
                    </React.Fragment>
                  ))}
                </List>
              </Paper>
      ...
      <Box component="footer" py={3} bgcolor="background.paper" borderTop={1} borderColor="divider">
        <Container maxWidth="md">
          <Typography variant="body2" color="text.secondary" align="center">
            XML 文件上传工具 - 支持拖拽上传、点击选择和键盘操作
          </Typography>
        </Container>
      </Box>
    </div>
