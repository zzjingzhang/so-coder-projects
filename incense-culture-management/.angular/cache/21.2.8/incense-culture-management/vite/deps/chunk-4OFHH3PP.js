...
var dtwt = (theme2 = {}, tokenPath, fallback, type) => {
  if (tokenPath) {
    ...
    const { prefix, transform } = (theme2 == null ? void 0 : theme2.options) || OPTIONS || {};
    const regex = /{([^}]*)}/g;
...
function toVariables_default(theme2, options = {}) {
  ...
  const { variables, tokens } = _toVariables(theme2, prefix);
  return {
    value: variables,
    tokens,
...
var themeUtils_default = {
  ...
  _toVariables(theme2, options) {
    return toVariables_default(theme2, { prefix: options == null ? void 0 : options.prefix });
  },
  getCommon({ name = "", theme: theme2 = {}, params, set, defaults }) {
    var _e, _f, _g, _h, _i, _j, _k;
    const { preset, options } = theme2;
  ...
  getPresetC({ name = "", theme: theme2 = {}, params, set, defaults }) {
    var _a;
    const { preset, options } = theme2;
    const cPreset = (_a = preset == null ? void 0 : preset.components) == null ? void 0 : _a[name];
    return this.getPreset({ name, preset: cPreset, options, params, set, defaults });
  },
  getPresetD({ name = "", theme: theme2 = {}, params, set, defaults }) {
    var _a;
  ...
  getCommonStyleSheet({ name = "", theme: theme2 = {}, params, props = {}, set, defaults }) {
    const common = this.getCommon({ name, theme: theme2, params, set, defaults });
  ...
  getStyleSheet({ name = "", theme: theme2 = {}, params, props = {}, set, defaults }) {
    var _a;
    const options = { name, theme: theme2, params, set, defaults };
...
//# sourceMappingURL=chunk-4OFHH3PP.js.map
