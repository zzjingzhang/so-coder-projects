    ...
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          ...
          '100%': { 
            boxShadow: '0 0 10px rgba(0, 243, 255, 0.8), 0 0 20px rgba(0, 243, 255, 0.5), 0 0 30px rgba(0, 243, 255, 0.3)' 
          },
        },
        float: {
      ...
      backgroundImage: {
        ...
        'neon-gradient': 'linear-gradient(135deg, #00f3ff 0%, #bd00ff 50%, #ff009d 100%)',
      }
    },
  },
  plugins: [],
