        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="relative bg-white/70 dark:bg-white/5 backdrop-blur-xl border border-black/10 dark:border-white/10 rounded-3xl p-8">
              <div className="aspect-square rounded-2xl bg-gradient-to-br from-blue-500/20 via-purple-500/20 to-pink-500/20 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="mt-4 text-gray-600 dark:text-gray-400">5+ Years Experience</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center p-4 bg-white/70 dark:bg-white/5 backdrop-blur-md border border-black/10 dark:border-white/10 rounded-xl">
